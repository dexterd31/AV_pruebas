...
--
-- Host: localhost:8889
-- Generation Time: Jun 17, 2020 at 02:51 PM
...
(1, 'Andres', 'andresd31@gmail.com', 'Excelentes vacaciones, muchas gracias!!!'),
(4, 'Jaime', 'james@guns.com', 'Excelente servicio, Recomendado'),
(5, 'wilson', 'wyy@hotmail.com', 'excelente todo lo que paso, fue una de las mejores cosas para hacer de verdad lo disfrute muchisimo, muchas gracias...'),
(6, 'Maria', 'lopela@ibm.com', 'adsfgagadg adfg fdga ag adg adgagaretgfdgshdfhd hdghghfghertyertyetryvbhxvbxnx srgsgsdfgsfdgsdfgsdfgs sdgsgsdfgertwsbnfgmfgjaadhgsgdhjfkgiouil fgkfjk fkfkf fhjdghjfjruryurtyicmncmcc mcmvmcvm zvbzbxcbzvc '),
(7, 'Javier', 'elnegro@hotmail.com', 'lo pelan con sus vacaciones, pero fueron chimbitas!!!!');
...
INSERT INTO `viajes` (`ID`, `TITULO`, `PRECIO`, `FECHA_IDA`, `FECHA_REGRESO`, `IMAGEN`, `DESCRIPCION`, `DISPONIBLES`) VALUES
